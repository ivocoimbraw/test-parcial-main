  ...
  return (
    <ContextMenu>
      <ContextMenuTrigger>
        <div
          className={cn(
            "flex items-center py-1 px-2 cursor-pointer text-sm hover:bg-gray-800 hover:text-white rounded group",
            isSelected && "bg-gray-800 hover:bg-gray-500",
            isHidden && "opacity-50"
          )}
        ...
        >
          {hasChildren && (
            <button onClick={handleToggleExpand} className="mr-1 text-gray-100 hover:text-gray-700">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                size="sm"
                className="h-6 w-6 p-0  group-hover:opacity-100 hover:opacity-100"
